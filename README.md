...
- Dynamic Theme: Dark/Light mode toggle with smooth transitions
...
- 3D Floating Icons: Skill icons and profile elements with 3D animations

- Smooth Scrolling: Section transitions with scroll-triggered animations

- Hover Effects: Every interactive element has cyberpunk-themed hover states
